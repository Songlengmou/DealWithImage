...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            final TagView finalTagViewContainer1 = tagViewContainer;
            tagViewContainer.setOnTouchListener(new OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                        Log.e("tagView onTouch", motionEvent.getRawX() + "  \ny" + motionEvent.getRawY());
                    }
                    if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                        Log.e("tagView onTouch", motionEvent.getRawX() + "  \ny" + motionEvent.getRawY());
                    }
                    if (mOnItemListener != null)
                        mOnItemListener.onClickListener(position, finalTagViewContainer1, (int) motionEvent.getRawX(), (int) motionEvent.getRawY());
                    return false;
                }
            });
        }
    ...
    public interface OnItemListener {
        void onClickListener(int position, TagView tagViewContainer, int x, int y);
    }
}
